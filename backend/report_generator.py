...
def generate_pdf_report(
    ...
    if "error" in technical_analysis:
        ...
        # Display raw indicator values instead of scores
    ...
    # --- Column 2 ---
    # Reset Y to align with top of column 1, accounting for dynamic height
    current_y = pdf.get_y()
    pdf.set_xy(pdf.w / 2, 55) 
    ...
    # --- THIS IS THE FIX ---
    # The output() method in fpdf2 returns a bytearray, which is what Streamlit needs.
    # The .encode() call is unnecessary and was causing the error.
    return pdf.output()
